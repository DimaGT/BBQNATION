            ...
            $('body').waitForImages({
                finished: function () {
                    ...
                    setTimeout(function () {
                        ...
                        gsap.set(
                            $('#showcase-carousel-holder .swiper-slide-active'),
                        ...
                        $('.slide-small-title span').each(function (
                            index,
                            element
                        ) {
                            tlSmallTitles.to(
                        ...
                        $('.sl-subtitle span, .split-subtitle span').each(
    ...
    function PageLoadActions() {
        ...
        if (!$('body').hasClass('disable-ajaxload')) {
            $('#page-nav .page-title').on('click', function () {
                ...
                gsap.to(
                    '.page-nav-caption:not(.marquee-title) .next-hero-title span',
                    {
                        duration: 0.5,
                        y: -140,
                        opacity: 0,
                ...
                gsap.to(
                    '.page-nav-caption.marquee-title .next-hero-title span',
                    {
                        duration: 0.5,
                        y: -300,
                        opacity: 0,
        ...
        if ($('#showcase-slider-holder').length > 0) {
            ...
            const showcaseSwiper = new Swiper('#showcase-slider', {
                ...
                on: {
                        ...
                        $('.showcase-pagination')
                            ...
                            .each(function () {
                                if (
                                    ...
                                    gsap.to(
                                        $(this).find('.translate-element span'),
                                        {
                                            duration: 0.5,
                                            y: 120,
                                            opacity: 0,
                    ...
                    slideChangeTransitionStart: function () {
                        ...
                        if (
                            $('.swiper-slide-active').hasClass('change-header')
                        ) {
                            $('#page-content')
                                .delay(500)
                                .queue(function (next) {
                        ...
                        if (
                            $('.swiper-slide-duplicate-active').hasClass(
                                'change-header'
                            )
                        ) {
                            $('#page-content')
            ...
            function BulletsPosition() {
                ...
                var bullets_count_width =
                    ($('.swiper-pagination-bullet .parallax-wrap').length *
                        40) /
                    2;
                var bullets_height =
                    $('.showcase-pagination-wrap').height() / 2;
                ...
                for (i = 0; i < bullets_count; i++) {
                    $('.swiper-pagination-bullet .parallax-wrap')
                        ...
                        .css(
                            'left',
                            i * 40 - bullets_count_width + window_width
                        )
                        .css(
                            'top',
                            bullets_height - 20 + window_height - footer_height
                        );
                }
            }
            ...
            if (!isMobile()) {
                ...
                $('#showcase-slider-holder .slide-title-wrapper').on(
                    ...
                    function () {
                        ...
                        $('#showcase-slider-holder .slide-title').addClass(
                            'hover-title'
                        );
                    }
                );
                    ...
                    triggerSlide.forEach((el) => {
                        el.addEventListener('click', function () {
                            if (!gl_canvas.isRunning) {
                                ...
                                gsap.to(
                                    gl_canvas.material.uniforms.dispFactor,
                                    {
                                        duration: 1,
                                        value: 1,
                                        ease: 'Sine.easeInOut',
            ...
            if (!isMobile()) {
                ...
                class HoverImgFx1 {
                    constructor(el) {
                        this.DOM = { el: el };
                        this.DOM.reveal =
                            this.DOM.el.querySelector('.hover-reveal');
                        this.DOM.revealInner = this.DOM.reveal.querySelector(
                            '.hover-reveal__inner'
                        );
                        this.DOM.revealInner.style.overflow = 'hidden';
                        this.DOM.revealImg =
                            this.DOM.revealInner.querySelector(
                                '.hover-reveal__img'
                            );
                        this.initEvents();
                    }
                        ...
                        this.positionElement = (ev) => {
                            ...
                            if ($('body').hasClass('smooth-scroll')) {
                                ...
                                gsap.to($('.hover-reveal'), {
                                    duration: 1,
                                    top: `${
                                        mousePos.y + 40 - docScrolls.top
                                    }px`,
                                    left: `${
                                        mousePos.x + 10 - docScrolls.left
                                    }px`,
                                    ease: Power4.easeOut,
                                });
                            }
            ...
            if ($(window).width() > 1024) {
                ...
                gsap.utils
                    ...
                    .forEach((showcaseReverse) => {
                        ...
                        const leftCol = gsap.utils.toArray(
                            '.col-reverse-left .sr-slide'
                        );
                        ...
                        for (var i = 0; i < leftCol.length; i++) {
                            ...
                            var leftImagesHeight =
                                0 - $(leftLastchild).outerHeight(true);
                            leftImages.forEach(function (leftImage) {
                                leftImagesHeight +=
                                    $(leftImage).outerHeight(true);
                            });
                        }
                        ...
                        for (var i = 0; i < centerCol.length; i++) {
                            ...
                            const centerImages = gsap.utils.toArray(
                                centerCol,
                                theCenterCol
                            );
                        ...
                        const rightCol = gsap.utils.toArray(
                            '.col-reverse-right .sr-slide'
                        );
                        ...
                        for (var i = 0; i < rightCol.length; i++) {
                            ...
                            var rightImagesHeight =
                                0 - $(rightLastchild).outerHeight(true);
                            rightImages.forEach(function (rightImage) {
                                rightImagesHeight +=
                                    $(rightImage).outerHeight(true);
                            });
                        }
                            ...
                            gsap.utils
                                ...
                                .forEach((parallaxElement, index) => {
                                    const parallaxElementChild =
                                        parallaxElement.querySelector(
                                            '.item-parallax'
                                        );
                                    const offsetParallax =
                                        parallaxElementChild.offsetHeight;
                                    gsap.fromTo(
            ...
            if ($('.portfolio-wrap').hasClass('ladder-grid')) {
                if ($(window).width() > 767) {
                    ...
                    delSections.forEach((itemThumb) => {
                        let imageAnim = gsap.to(
                            itemThumb.querySelector('.item-parallax'),
                            {
                                y: '-100vh',
                                ease: 'none',
                                paused: true,
                        ...
                        let progressTo = gsap.quickTo(imageAnim, 'progress', {
                            ease: 'power3',
                            duration:
                                parseFloat(itemThumb.dataset.scrub) || 0.2,
                        });
                            ...
                            gsap.utils
                                ...
                                .forEach((parallaxElement, index) => {
                                    ...
                                    const startMovement =
                                        ...
                                        parallaxElement.dataset.startparallax;
                                    const endMovement =
                                        parallaxElement.offsetHeight * 0.25;
                                    gsap.fromTo(
                                        parallaxElementChild,
                                        { y: 0 },
                                        {
            ...
            $('#show-filters, #close-filters').on('click', function () {
                ...
                setTimeout(function () {
                    if ($('#filters-overlay').hasClass('active')) {
                        ...
                        $('.filters-timeline a').each(function (
                            index,
                            element
                        ) {
                            tlMenu.to(
                        ...
                        var tlMenu = gsap.timeline();
                        $('.filters-timeline a, .jssocials-share').each(
                            function (index, element) {
                                tlMenu.to(
                                    element,
                                    {
...
let anim_1 = document.querySelector('.gif_7_container');
let anim_2 = document.querySelector('.gif_8');
let anim_3 = document.querySelector('.gif_18');
let anim_4 = document.querySelector('.gif_7_container');
let anim_5 = document.querySelector('.gif_2');
let anim_6 = document.querySelector('.gif_4');
let anim_7 = document.querySelector('.gif_7');
let anim_8 = document.querySelector('.gif_11');
let anim_9 = document.querySelector('.gif_9');
let anim_10 = document.querySelector('.gif_12');
let anim_11 = document.querySelector('.gif_15');
let anim_12 = document.querySelector('.gif_22');
